import { WbClustersRepositoryAdSpend } from "./wb-clusters.repository.ad-spend";
...
export abstract class WbClustersRepositoryStocks extends WbClustersRepositoryAdSpend {
