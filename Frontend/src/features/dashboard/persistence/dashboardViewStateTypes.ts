...
export type ActiveSheet = "none" | "cost-price" | "orders" | "stocks" | "prices" | "buyout" | "orders-sum" | "revenue" | "cost-sum" | "spp" | "ad-spend" | "acquiring";
...
export function isActiveSheet(value: unknown): value is ActiveSheet {
  return value === "none" || value === "cost-price" || value === "orders" || value === "stocks" || value === "prices" || value === "buyout" || value === "orders-sum" || value === "revenue" || value === "cost-sum" || value === "spp" || value === "ad-spend" || value === "acquiring";
}
